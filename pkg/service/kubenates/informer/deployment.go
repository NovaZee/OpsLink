...
func (d *DeploymentInformer) OnAdd(obj interface{}, isInInitialList bool) {
	...
	logger.Debugw("deployment informer webhook", "action", "OnAdd", "Name", obj.(*v1.Deployment).Name, "namespace", obj.(*v1.Deployment).Namespace)
	//ws推送
}
...
func (d *DeploymentInformer) OnUpdate(oldObj, newObj interface{}) {
	...
	logger.Debugw("deployment informer webhook", "action", "OnUpdate", "Name", newObj.(*v1.Deployment).Name, "namespace", newObj.(*v1.Deployment).Namespace)
}
...
func (d *DeploymentInformer) OnDelete(obj interface{}) {
	...
	logger.Debugw("deployment informer webhook", "action", "OnDelete", "Name", obj.(*v1.Deployment).Name, "namespace", obj.(*v1.Deployment).Namespace)
}
